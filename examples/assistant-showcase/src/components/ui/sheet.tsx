...
function SheetContent({
  ...
  side?: keyof typeof sheetContentPositions
}) {
  return (
    <SheetPortal>
      <SheetOverlay />
      ...
      >
        ...
        <SheetPrimitive.Close
          className="absolute top-4 right-4 rounded-md p-1 text-muted-foreground opacity-70 transition-opacity hover:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none"
        >
