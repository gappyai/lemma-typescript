export type LemmaProgressTrackerAppearance = "default" | "borderless" | "minimal" | "contained"
export type LemmaProgressTrackerDensity = "compact" | "comfortable" | "spacious"
export type LemmaProgressTrackerRadius = "none" | "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "full"

const RADIUS_MAP: Record<LemmaProgressTrackerRadius, Record<string, string>> = {
...
export function progressTrackerRadiusClassName(
