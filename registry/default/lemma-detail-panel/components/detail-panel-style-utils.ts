export type LemmaDetailPanelAppearance = "default" | "borderless" | "minimal" | "contained"
export type LemmaDetailPanelDensity = "compact" | "comfortable" | "spacious"
export type LemmaDetailPanelRadius = "none" | "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "full"

const RADIUS_MAP: Record<LemmaDetailPanelRadius, Record<string, string>> = {
...
export function detailPanelRadiusClassName(
