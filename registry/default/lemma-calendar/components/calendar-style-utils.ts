export type LemmaCalendarAppearance = "default" | "borderless" | "minimal" | "contained"
export type LemmaCalendarDensity = "compact" | "comfortable" | "spacious"
export type LemmaCalendarRadius = "none" | "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "full"

const RADIUS_MAP: Record<LemmaCalendarRadius, Record<string, string>> = {
...
export function calendarRadiusClassName(
