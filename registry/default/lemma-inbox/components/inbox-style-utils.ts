export type LemmaInboxAppearance = "default" | "borderless" | "minimal" | "contained"
export type LemmaInboxDensity = "compact" | "comfortable" | "spacious"
export type LemmaInboxRadius = "none" | "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "full"

const RADIUS_MAP: Record<LemmaInboxRadius, Record<string, string>> = {
...
export function inboxRadiusClassName(
