export type LemmaTimelineAppearance = "default" | "borderless" | "minimal" | "contained"
export type LemmaTimelineDensity = "compact" | "comfortable" | "spacious"
export type LemmaTimelineRadius = "none" | "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "full"

const RADIUS_MAP: Record<LemmaTimelineRadius, Record<string, string>> = {
...
export function timelineRadiusClassName(
