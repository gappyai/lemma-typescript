export type LemmaMatrixAppearance = "default" | "borderless" | "minimal" | "contained"
export type LemmaMatrixDensity = "compact" | "comfortable" | "spacious"
export type LemmaMatrixRadius = "none" | "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "full"

const RADIUS_MAP: Record<LemmaMatrixRadius, Record<string, string>> = {
...
export function matrixRadiusClassName(
