export type LemmaChecklistAppearance = "default" | "borderless" | "minimal" | "contained"
export type LemmaChecklistDensity = "compact" | "comfortable" | "spacious"
export type LemmaChecklistRadius = "none" | "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "full"

const RADIUS_MAP: Record<LemmaChecklistRadius, Record<string, string>> = {
...
export function checklistRadiusClassName(
