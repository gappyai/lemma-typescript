...
export interface LemmaFunctionRunHistoryProps {
  client: LemmaClient
  podId?: string
  functionName: string
  title?: string
...
export function LemmaFunctionRunHistory({
  client,
  podId,
  functionName,
        ...
        {history.runs.length === 0 ? (
          ...
          history.runs.map((run) => (
            ...
            >
              ...
              <div className="mt-1 truncate text-xs text-muted-foreground">{run.id}</div>
            </button>
          ))
        )}
