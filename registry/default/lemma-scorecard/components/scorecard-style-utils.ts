export type LemmaScorecardAppearance = "default" | "minimal" | "borderless" | "contained"
export type LemmaScorecardDensity = "compact" | "comfortable" | "spacious"
export type LemmaScorecardRadius = "none" | "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "full"

const RADIUS_MAP: Record<LemmaScorecardRadius, Record<string, string>> = {
...
export function scorecardRadiusClassName(
