export type LemmaOrgChartAppearance = "default" | "minimal" | "borderless" | "contained"
export type LemmaOrgChartDensity = "compact" | "comfortable" | "spacious"
export type LemmaOrgChartRadius = "none" | "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "full"

const RADIUS_MAP: Record<LemmaOrgChartRadius, Record<string, string>> = {
...
export function orgChartRadiusClassName(
